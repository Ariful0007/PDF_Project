...
public class Books extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        documentReference=firebaseFirestore.collection("Book_pdf").document();
    ...
    private void reciveData() {
        firebaseFirestore.collection("Book_pdf").addSnapshotListener(new EventListener<QuerySnapshot>() {
            @Override
