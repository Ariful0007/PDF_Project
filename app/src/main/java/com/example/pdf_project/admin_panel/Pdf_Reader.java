...
public class Pdf_Reader extends AppCompatActivity {
    String link="gfh",productList="fgh",product="gfhh";
    PDFView pdfView;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_pdf__reader);
       ...
       // link=getIntent().getStringExtra("link");
        ...
        if (isConnected()) {
            ...
            AlertDialog.Builder builder = new AlertDialog.Builder(Pdf_Reader.this);
            builder.setTitle("NoInternet Connection Alert")
                    ...
                    .setNegativeButton("No", new DialogInterface.OnClickListener() {
                        @Override
                        public void onClick(DialogInterface dialog, int which) {
                            Toast.makeText(getApplicationContext(),"Go Back TO HomePage!", Toast.LENGTH_SHORT).show();
                        }
                    });
            //Creating dialog box
        ...
        new Pdf_Reader.RetrievePDFStream().execute(link);
    }
    ...
    class RetrievePDFStream extends AsyncTask<String, Void, InputStream> {
        ...
        {
            progressDialog = new ProgressDialog(Pdf_Reader.this);
