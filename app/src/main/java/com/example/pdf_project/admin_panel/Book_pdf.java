...
public class Book_pdf extends AppCompatActivity implements View.OnClickListener {
                ...
                .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                    ...
                    public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                        ...
                        if (uriTask.isSuccessful()) {
                            ...
                            Upload upload=new Upload(editTextFilename.getText().toString(),downloadUri.toString().trim());
                            firebaseFirestore.collection("Book_pdf")
